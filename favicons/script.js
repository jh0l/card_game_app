...
const configuration = {
  ...
  appShortName: '72vcards', // Your application's short_name. `string`. Optional. If not set, appName will be used
  appDescription: '72vcards', // Your application's description. `string`
  developerName: '72vcards', // Your (or your developer's) name. `string`
  developerURL: '72vcards', // Your (or your developer's) URL. `string`
  ...
  theme_color: '#000000', // Theme color user for example in Android's task switcher. `string`
